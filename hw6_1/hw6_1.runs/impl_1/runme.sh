...
HD_PWD='E:/model/hw6_1/hw6_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Synchronous_D_FF.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Synchronous_D_FF.tcl -notrace
