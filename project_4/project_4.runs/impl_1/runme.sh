...
HD_PWD='E:/model/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_gates_1.vdi -applog -m64 -messageDb vivado.pb -mode batch -source logic_gates_1.tcl -notrace
