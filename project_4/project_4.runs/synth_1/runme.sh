...
HD_PWD='E:/model/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_gates_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source logic_gates_1.tcl
