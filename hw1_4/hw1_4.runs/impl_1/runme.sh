...
HD_PWD='E:/model/hw1_4/hw1_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log three_state_gates.vdi -applog -m64 -messageDb vivado.pb -mode batch -source three_state_gates.tcl -notrace
