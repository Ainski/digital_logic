...
HD_PWD='E:/model/hw1_4/hw1_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log three_state_gates.vds -m64 -mode batch -messageDb vivado.pb -notrace -source three_state_gates.tcl
