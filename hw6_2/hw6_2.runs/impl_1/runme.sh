...
HD_PWD='E:/model/hw6_2/hw6_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Asynchronous_D_FF.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Asynchronous_D_FF.tcl -notrace
