...
HD_PWD='E:/model/hw6_2/hw6_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Asynchronous_D_FF.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Asynchronous_D_FF.tcl
