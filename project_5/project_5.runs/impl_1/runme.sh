...
HD_PWD='E:/model/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder83_Pri.vdi -applog -m64 -messageDb vivado.pb -mode batch -source encoder83_Pri.tcl -notrace
