...
HD_PWD='E:/model/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder83_Pri.vds -m64 -mode batch -messageDb vivado.pb -notrace -source encoder83_Pri.tcl
