...
set rc [catch {
  ...
  set_property webtalk.parent_dir E:/model/hw3_2/hw3_2.cache/wt [current_project]
  set_property parent.project_path E:/model/hw3_2/hw3_2.xpr [current_project]
  set_property ip_repo_paths e:/model/hw3_2/hw3_2.cache/ip [current_project]
  set_property ip_output_repo e:/model/hw3_2/hw3_2.cache/ip [current_project]
  add_files -quiet E:/model/hw3_2/hw3_2.runs/synth_1/display7.dcp
  read_xdc E:/model/hw3_2/hw3_2.srcs/constrs_1/new/display7_xdc.xdc
  link_design -top display7 -part xc7a100tcsg324-1
