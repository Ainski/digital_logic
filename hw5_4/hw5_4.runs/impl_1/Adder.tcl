...
set rc [catch {
  ...
  set_property ip_repo_paths e:/model/hw5_4/hw5_4.cache/ip [current_project]
  set_property ip_output_repo e:/model/hw5_4/hw5_4.cache/ip [current_project]
  add_files -quiet E:/model/hw5_4/hw5_4.runs/synth_1/Adder.dcp
